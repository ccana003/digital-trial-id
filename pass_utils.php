 ...
 * Errors are returned to the module class, which records non-sensitive messages
 * through the External Module logging mechanism.
 */
...
function generate_wallet_link(
    ...
    try {
        ...
        $helpfulInformation = ["Start Date: $start_date"];
